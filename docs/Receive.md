# Invoicetronic.Sdk.Model.Receive
A received invoice.
...
**IsRead** | **bool** | Whether the invoice has been read at least once. Set to true only when the invoice is requested with include_payload&#x3D;true. | [optional] 
