...
namespace Invoicetronic.Invoice.Sdk.Test.Api
{
    ...
    public class SendApiTests : IDisposable
    {
        ...
        public void SendGetTest()
        {
            ...
            //int? pageSize = null;
            //string sort = null;
            //var response = instance.SendGet(companyId, identifier, committente, prestatore, fileName, lastUpdateFrom, lastUpdateTo, dateSentFrom, dateSentTo, documentDateFrom, documentDateTo, documentNumber, page, pageSize, sort);
        ...
        public void SendIdGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int id = null;
            //var response = instance.SendIdGet(id);
            //Assert.IsType<Send>(response);
        }
        ...
        /// </summary>
        [Fact]
        public void SendValidateFilesPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //List<System.IO.Stream> files = null;
            //instance.SendValidateFilesPost(files);
        }
