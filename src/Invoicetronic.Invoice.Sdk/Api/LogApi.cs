...
namespace Invoicetronic.Invoice.Sdk.Api
{
    ...
    public partial class LogApi : ILogApi
    {
        ...
        {
            Invoicetronic.Invoice.Sdk.Client.ApiResponse<Event> localVarResponse = InvoiceV1LogIdGetWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        {
            Invoicetronic.Invoice.Sdk.Client.ApiResponse<Event> localVarResponse = await InvoiceV1LogIdGetWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Event)</returns>
        public async System.Threading.Tasks.Task<Invoicetronic.Invoice.Sdk.Client.ApiResponse<Event>> InvoiceV1LogIdGetWithHttpInfoAsync(int id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
