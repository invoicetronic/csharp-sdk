...
namespace Invoicetronic.Invoice.Sdk.Api
{
    ...
    public partial class ReceiveApi : IReceiveApi
    {
        ...
        {
            Invoicetronic.Invoice.Sdk.Client.ApiResponse<List<Receive>> localVarResponse = InvoiceV1ReceiveGetWithHttpInfo(companyId, identifier, unread, committente, prestatore, fileName, lastUpdateFrom, lastUpdateTo, dateSentFrom, dateSentTo, documentDateFrom, documentDateTo, documentNumber, page, pageSize);
        ...
        {
            Invoicetronic.Invoice.Sdk.Client.ApiResponse<List<Receive>> localVarResponse = await InvoiceV1ReceiveGetWithHttpInfoAsync(companyId, identifier, unread, committente, prestatore, fileName, lastUpdateFrom, lastUpdateTo, dateSentFrom, dateSentTo, documentDateFrom, documentDateTo, documentNumber, page, pageSize, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Receive&gt;)</returns>
        public async System.Threading.Tasks.Task<Invoicetronic.Invoice.Sdk.Client.ApiResponse<List<Receive>>> InvoiceV1ReceiveGetWithHttpInfoAsync(int? companyId = default(int?), string identifier = default(string), bool? unread = default(bool?), string committente = default(string), string prestatore = default(string), string fileName = default(string), DateTime? lastUpdateFrom = default(DateTime?), DateTime? lastUpdateTo = default(DateTime?), DateTime? dateSentFrom = default(DateTime?), DateTime? dateSentTo = default(DateTime?), DateTime? documentDateFrom = default(DateTime?), DateTime? documentDateTo = default(DateTime?), string documentNumber = default(string), int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        {
            Invoicetronic.Invoice.Sdk.Client.ApiResponse<Receive> localVarResponse = InvoiceV1ReceiveIdDeleteWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        {
            Invoicetronic.Invoice.Sdk.Client.ApiResponse<Receive> localVarResponse = await InvoiceV1ReceiveIdDeleteWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Receive)</returns>
        public async System.Threading.Tasks.Task<Invoicetronic.Invoice.Sdk.Client.ApiResponse<Receive>> InvoiceV1ReceiveIdDeleteWithHttpInfoAsync(int id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        {
            Invoicetronic.Invoice.Sdk.Client.ApiResponse<Receive> localVarResponse = InvoiceV1ReceiveIdGetWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        {
            Invoicetronic.Invoice.Sdk.Client.ApiResponse<Receive> localVarResponse = await InvoiceV1ReceiveIdGetWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Receive)</returns>
        public async System.Threading.Tasks.Task<Invoicetronic.Invoice.Sdk.Client.ApiResponse<Receive>> InvoiceV1ReceiveIdGetWithHttpInfoAsync(int id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
