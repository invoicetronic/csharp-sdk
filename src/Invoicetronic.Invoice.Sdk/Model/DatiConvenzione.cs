...
namespace Invoicetronic.Invoice.Sdk.Model
{
    ...
    /// DatiConvenzione
    /// </summary>
    [DataContract(Name = "DatiConvenzione")]
    public partial class DatiConvenzione : IValidatableObject
    {
        ...
        public DatiConvenzione(List<int> riferimentoNumeroLinea = default(List<int>), string idDocumento = default(string), DateTime? data = default(DateTime?), string numItem = default(string), string codiceCommessaConvenzione = default(string), string codiceCup = default(string), string codiceCig = default(string))
        {
