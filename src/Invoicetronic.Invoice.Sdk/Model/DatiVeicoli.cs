...
namespace Invoicetronic.Invoice.Sdk.Model
{
    ...
    public partial class DatiVeicoli : IValidatableObject
    {
        ...
        public DatiVeicoli(DateTime? data = default(DateTime?), string totalePercorso = default(string))
        {
            this.Data = data;
        ...
        /// </summary>
        [DataMember(Name = "totale_percorso", EmitDefaultValue = true)]
