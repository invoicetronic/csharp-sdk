...
namespace Invoicetronic.InvoiceApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DatiAnagraficiCessionarioCommittente")]
    public partial class DatiAnagraficiCessionarioCommittente : IValidatableObject
    {
        ...
        public DatiAnagraficiCessionarioCommittente(IdFiscaleIVA idFiscaleIva = default(IdFiscaleIVA), string codiceFiscale = default(string), Anagrafica anagrafica = default(Anagrafica))
        {
