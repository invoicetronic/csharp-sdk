...
namespace Invoicetronic.InvoiceApi.Model
{
    ...
    /// DatiContratto
    /// </summary>
    [DataContract(Name = "DatiContratto")]
    public partial class DatiContratto : IValidatableObject
    {
        ...
        public DatiContratto(List<int> riferimentoNumeroLinea = default(List<int>), string idDocumento = default(string), DateTime? data = default(DateTime?), string numItem = default(string), string codiceCommessaConvenzione = default(string), string codiceCup = default(string), string codiceCig = default(string))
        {
