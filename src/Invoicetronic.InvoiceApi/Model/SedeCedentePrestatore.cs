...
namespace Invoicetronic.InvoiceApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SedeCedentePrestatore")]
    public partial class SedeCedentePrestatore : IValidatableObject
    {
        ...
        public SedeCedentePrestatore(string indirizzo = default(string), string numeroCivico = default(string), string cap = default(string), string comune = default(string), string provincia = default(string), string nazione = @"IT")
        {
