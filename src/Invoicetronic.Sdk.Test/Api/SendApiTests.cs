...
namespace Invoicetronic.Sdk.Test.Api
{
    ...
    public class SendApiTests : IDisposable
    {
        ...
        public void SendGetTest()
        {
            ...
            //string sort = null;
            //string q = null;
            //var response = instance.SendGet(companyId, identifier, committente, prestatore, fileName, lastUpdateFrom, lastUpdateTo, dateSentFrom, dateSentTo, documentDateFrom, documentDateTo, documentNumber, includePayload, ids, page, pageSize, sort, q);
