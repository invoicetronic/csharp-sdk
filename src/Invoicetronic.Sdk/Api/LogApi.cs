...
namespace Invoicetronic.Sdk.Api
{
    ...
    public partial class LogApi : IDisposable, ILogApi
    {
        ...
        {
            Invoicetronic.Sdk.Client.ApiResponse<List<Event>> localVarResponse = LogGetWithHttpInfo(companyId, endpoint, method, apiVerion, statusCode, dateCreatedFrom, dateCreatedTo, page, pageSize, sort, query, success, dateTimeFrom, dateTimeTo, userAgent);
        ...
        public Invoicetronic.Sdk.Client.ApiResponse<List<Event>> LogGetWithHttpInfo(int? companyId = default, string endpoint = default, string method = default, int? apiVerion = default, int? statusCode = default, DateTime? dateCreatedFrom = default, DateTime? dateCreatedTo = default, int? page = default, int? pageSize = default, string sort = default, string query = default, bool? success = default, DateTime? dateTimeFrom = default, DateTime? dateTimeTo = default, string userAgent = default)
        {
            ...
            if (userAgent != null)
            {
                localVarRequestOptions.QueryParameters.Add(Invoicetronic.Sdk.Client.ClientUtils.ParameterToMultiMap("", "user_agent", userAgent));
            }
        ...
        {
            Invoicetronic.Sdk.Client.ApiResponse<List<Event>> localVarResponse = await LogGetWithHttpInfoAsync(companyId, endpoint, method, apiVerion, statusCode, dateCreatedFrom, dateCreatedTo, page, pageSize, sort, query, success, dateTimeFrom, dateTimeTo, userAgent, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
