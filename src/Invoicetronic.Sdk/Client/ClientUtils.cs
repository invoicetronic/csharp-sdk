...
[assembly: InternalsVisibleTo("Invoicetronic.Sdk.Test")]
        ...
        public static string ParameterToString(object obj, string format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is Receive.EncodingEnum receiveEncodingEnum)
                return Receive.EncodingEnumToJsonValue(receiveEncodingEnum);
            if (obj is Send.EncodingEnum sendEncodingEnum)
                return Send.EncodingEnumToJsonValue(sendEncodingEnum);
            if (obj is Update.StateEnum updateStateEnum)
                return Update.StateEnumToJsonValue(updateStateEnum);
