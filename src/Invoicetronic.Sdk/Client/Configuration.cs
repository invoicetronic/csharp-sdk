...
namespace Invoicetronic.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "main";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("Invoicetronic/main/CSharp-SDK");
        ...
        {
            string report = "C# SDK (Invoicetronic.Sdk) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 1\n";
            report += "    SDK Package Version: main\n";
