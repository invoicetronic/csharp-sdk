...
namespace Invoicetronic.Sdk.Model
{
    ...
    public partial class DatiCassaPrevidenziale : IValidatableObject
    {
        ...
        public DatiCassaPrevidenziale(string tipoCassa = default, double alCassa = default, double importoContributoCassa = default, double imponibileCassa = default, double aliquotaIva = default, string ritenuta = default, string natura = default, string riferimentoAmministrazione = default)
        {
