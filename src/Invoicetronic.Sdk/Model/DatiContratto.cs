...
namespace Invoicetronic.Sdk.Model
{
    ...
    public partial class DatiContratto : IValidatableObject
    {
        ...
        public DatiContratto(List<int> riferimentoNumeroLinea = default, string idDocumento = default, DateTime? data = default, string numItem = default, string codiceCommessaConvenzione = default, string codiceCup = default, string codiceCig = default)
        {
