...
namespace Invoicetronic.Sdk.Model
{
    ...
    /// DatiContratto
    /// </summary>
    public partial class DatiContratto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DatiContratto" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public DatiContratto(Option<List<int>> riferimentoNumeroLinea = default, Option<string> idDocumento = default, Option<DateTime?> data = default, Option<string> numItem = default, Option<string> codiceCommessaConvenzione = default, Option<string> codiceCup = default, Option<string> codiceCig = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="DatiContratto" />
    /// </summary>
    public class DatiContrattoJsonConverter : JsonConverter<DatiContratto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="DatiContratto" />
        /// </summary>
        ...
        public override DatiContratto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new DatiContratto(riferimentoNumeroLinea, idDocumento, data, numItem, codiceCommessaConvenzione, codiceCup, codiceCig);
        }

        /// <summary>
        /// Serializes a <see cref="DatiContratto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="datiContratto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DatiContratto datiContratto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, datiContratto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DatiContratto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="datiContratto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DatiContratto datiContratto, JsonSerializerOptions jsonSerializerOptions)
        {
            if (datiContratto.RiferimentoNumeroLineaOption.IsSet)
                if (datiContratto.RiferimentoNumeroLineaOption.Value != null)
                {
                    writer.WritePropertyName("riferimento_numero_linea");
                    JsonSerializer.Serialize(writer, datiContratto.RiferimentoNumeroLinea, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("riferimento_numero_linea");
            if (datiContratto.IdDocumentoOption.IsSet)
                if (datiContratto.IdDocumentoOption.Value != null)
                    writer.WriteString("id_documento", datiContratto.IdDocumento);
                else
                    writer.WriteNull("id_documento");

            if (datiContratto.DataOption.IsSet)
                if (datiContratto.DataOption.Value != null)
                    writer.WriteString("data", datiContratto.DataOption.Value.Value.ToString(DataFormat));
                else
                    writer.WriteNull("data");

            if (datiContratto.NumItemOption.IsSet)
                if (datiContratto.NumItemOption.Value != null)
                    writer.WriteString("num_item", datiContratto.NumItem);
                else
                    writer.WriteNull("num_item");

            if (datiContratto.CodiceCommessaConvenzioneOption.IsSet)
                if (datiContratto.CodiceCommessaConvenzioneOption.Value != null)
                    writer.WriteString("codice_commessa_convenzione", datiContratto.CodiceCommessaConvenzione);
                else
                    writer.WriteNull("codice_commessa_convenzione");

            if (datiContratto.CodiceCupOption.IsSet)
                if (datiContratto.CodiceCupOption.Value != null)
                    writer.WriteString("codice_cup", datiContratto.CodiceCup);
                else
                    writer.WriteNull("codice_cup");

            if (datiContratto.CodiceCigOption.IsSet)
                if (datiContratto.CodiceCigOption.Value != null)
                    writer.WriteString("codice_cig", datiContratto.CodiceCig);
                else
