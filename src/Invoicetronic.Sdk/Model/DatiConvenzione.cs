...
namespace Invoicetronic.Sdk.Model
{
    ...
    /// DatiConvenzione
    /// </summary>
    public partial class DatiConvenzione : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DatiConvenzione" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public DatiConvenzione(Option<List<int>> riferimentoNumeroLinea = default, Option<string> idDocumento = default, Option<DateTime?> data = default, Option<string> numItem = default, Option<string> codiceCommessaConvenzione = default, Option<string> codiceCup = default, Option<string> codiceCig = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="DatiConvenzione" />
    /// </summary>
    public class DatiConvenzioneJsonConverter : JsonConverter<DatiConvenzione>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="DatiConvenzione" />
        /// </summary>
        ...
        public override DatiConvenzione Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new DatiConvenzione(riferimentoNumeroLinea, idDocumento, data, numItem, codiceCommessaConvenzione, codiceCup, codiceCig);
        }

        /// <summary>
        /// Serializes a <see cref="DatiConvenzione" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="datiConvenzione"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DatiConvenzione datiConvenzione, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, datiConvenzione, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DatiConvenzione" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="datiConvenzione"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DatiConvenzione datiConvenzione, JsonSerializerOptions jsonSerializerOptions)
        {
            if (datiConvenzione.RiferimentoNumeroLineaOption.IsSet)
                if (datiConvenzione.RiferimentoNumeroLineaOption.Value != null)
                {
                    writer.WritePropertyName("riferimento_numero_linea");
                    JsonSerializer.Serialize(writer, datiConvenzione.RiferimentoNumeroLinea, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("riferimento_numero_linea");
            if (datiConvenzione.IdDocumentoOption.IsSet)
                if (datiConvenzione.IdDocumentoOption.Value != null)
                    writer.WriteString("id_documento", datiConvenzione.IdDocumento);
                else
                    writer.WriteNull("id_documento");

            if (datiConvenzione.DataOption.IsSet)
                if (datiConvenzione.DataOption.Value != null)
                    writer.WriteString("data", datiConvenzione.DataOption.Value.Value.ToString(DataFormat));
                else
                    writer.WriteNull("data");

            if (datiConvenzione.NumItemOption.IsSet)
                if (datiConvenzione.NumItemOption.Value != null)
                    writer.WriteString("num_item", datiConvenzione.NumItem);
                else
                    writer.WriteNull("num_item");

            if (datiConvenzione.CodiceCommessaConvenzioneOption.IsSet)
                if (datiConvenzione.CodiceCommessaConvenzioneOption.Value != null)
                    writer.WriteString("codice_commessa_convenzione", datiConvenzione.CodiceCommessaConvenzione);
                else
                    writer.WriteNull("codice_commessa_convenzione");

            if (datiConvenzione.CodiceCupOption.IsSet)
                if (datiConvenzione.CodiceCupOption.Value != null)
                    writer.WriteString("codice_cup", datiConvenzione.CodiceCup);
                else
                    writer.WriteNull("codice_cup");

            if (datiConvenzione.CodiceCigOption.IsSet)
                if (datiConvenzione.CodiceCigOption.Value != null)
                    writer.WriteString("codice_cig", datiConvenzione.CodiceCig);
                else
