...
namespace Invoicetronic.Sdk.Model
{
    ...
    public partial class DatiConvenzione : IValidatableObject
    {
        ...
        public DatiConvenzione(List<int> riferimentoNumeroLinea = default, string idDocumento = default, DateTime? data = default, string numItem = default, string codiceCommessaConvenzione = default, string codiceCup = default, string codiceCig = default)
        {
