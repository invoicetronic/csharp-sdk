...
namespace Invoicetronic.Sdk.Model
{
    ...
    public partial class DatiFattureCollegate : IValidatableObject
    {
        ...
        [JsonConstructor]
        public DatiFattureCollegate(Option<List<int>> riferimentoNumeroLinea = default, Option<string> idDocumento = default, Option<DateTime?> data = default, Option<string> numItem = default, Option<string> codiceCommessaConvenzione = default, Option<string> codiceCup = default, Option<string> codiceCig = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="DatiFattureCollegate" />
    /// </summary>
    public class DatiFattureCollegateJsonConverter : JsonConverter<DatiFattureCollegate>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="DatiFattureCollegate" />
        /// </summary>
        ...
        public override DatiFattureCollegate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new DatiFattureCollegate(riferimentoNumeroLinea, idDocumento, data, numItem, codiceCommessaConvenzione, codiceCup, codiceCig);
        }

        /// <summary>
        /// Serializes a <see cref="DatiFattureCollegate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="datiFattureCollegate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DatiFattureCollegate datiFattureCollegate, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, datiFattureCollegate, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DatiFattureCollegate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="datiFattureCollegate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DatiFattureCollegate datiFattureCollegate, JsonSerializerOptions jsonSerializerOptions)
        {
            if (datiFattureCollegate.RiferimentoNumeroLineaOption.IsSet)
                if (datiFattureCollegate.RiferimentoNumeroLineaOption.Value != null)
                {
                    writer.WritePropertyName("riferimento_numero_linea");
                    JsonSerializer.Serialize(writer, datiFattureCollegate.RiferimentoNumeroLinea, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("riferimento_numero_linea");
            if (datiFattureCollegate.IdDocumentoOption.IsSet)
                if (datiFattureCollegate.IdDocumentoOption.Value != null)
                    writer.WriteString("id_documento", datiFattureCollegate.IdDocumento);
                else
                    writer.WriteNull("id_documento");

            if (datiFattureCollegate.DataOption.IsSet)
                if (datiFattureCollegate.DataOption.Value != null)
                    writer.WriteString("data", datiFattureCollegate.DataOption.Value.Value.ToString(DataFormat));
                else
                    writer.WriteNull("data");

            if (datiFattureCollegate.NumItemOption.IsSet)
                if (datiFattureCollegate.NumItemOption.Value != null)
                    writer.WriteString("num_item", datiFattureCollegate.NumItem);
                else
                    writer.WriteNull("num_item");

            if (datiFattureCollegate.CodiceCommessaConvenzioneOption.IsSet)
                if (datiFattureCollegate.CodiceCommessaConvenzioneOption.Value != null)
                    writer.WriteString("codice_commessa_convenzione", datiFattureCollegate.CodiceCommessaConvenzione);
                else
                    writer.WriteNull("codice_commessa_convenzione");

            if (datiFattureCollegate.CodiceCupOption.IsSet)
                if (datiFattureCollegate.CodiceCupOption.Value != null)
                    writer.WriteString("codice_cup", datiFattureCollegate.CodiceCup);
                else
                    writer.WriteNull("codice_cup");

            if (datiFattureCollegate.CodiceCigOption.IsSet)
                if (datiFattureCollegate.CodiceCigOption.Value != null)
                    writer.WriteString("codice_cig", datiFattureCollegate.CodiceCig);
                else
