...
namespace Invoicetronic.Sdk.Model
{
    ...
    public partial class DatiGeneraliDocumento : IValidatableObject
    {
        ...
        public DatiGeneraliDocumento(string tipoDocumento = default, string divisa = default, DateTime data = default, string numero = default, List<DatiRitenuta> datiRitenuta = default, DatiBollo datiBollo = default, List<DatiCassaPrevidenziale> datiCassaPrevidenziale = default, List<ScontoMaggiorazione> scontoMaggiorazione = default, double? importoTotaleDocumento = default, double? arrotondamento = default, List<string> causale = default, string art73 = default)
        {
