...
namespace Invoicetronic.Sdk.Model
{
    ...
    public partial class DatiOrdineAcquisto : IValidatableObject
    {
        ...
        public DatiOrdineAcquisto(List<int> riferimentoNumeroLinea = default, string idDocumento = default, DateTime? data = default, string numItem = default, string codiceCommessaConvenzione = default, string codiceCup = default, string codiceCig = default)
        {
