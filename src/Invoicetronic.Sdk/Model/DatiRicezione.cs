...
namespace Invoicetronic.Sdk.Model
{
    ...
    public partial class DatiRicezione : IValidatableObject
    {
        ...
        public DatiRicezione(List<int> riferimentoNumeroLinea = default, string idDocumento = default, DateTime? data = default, string numItem = default, string codiceCommessaConvenzione = default, string codiceCup = default, string codiceCig = default)
        {
