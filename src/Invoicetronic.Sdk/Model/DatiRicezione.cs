...
namespace Invoicetronic.Sdk.Model
{
    ...
    public partial class DatiRicezione : IValidatableObject
    {
        ...
        [JsonConstructor]
        public DatiRicezione(Option<List<int>> riferimentoNumeroLinea = default, Option<string> idDocumento = default, Option<DateTime?> data = default, Option<string> numItem = default, Option<string> codiceCommessaConvenzione = default, Option<string> codiceCup = default, Option<string> codiceCig = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="DatiRicezione" />
    /// </summary>
    public class DatiRicezioneJsonConverter : JsonConverter<DatiRicezione>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="DatiRicezione" />
        /// </summary>
        ...
        public override DatiRicezione Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new DatiRicezione(riferimentoNumeroLinea, idDocumento, data, numItem, codiceCommessaConvenzione, codiceCup, codiceCig);
        }

        /// <summary>
        /// Serializes a <see cref="DatiRicezione" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="datiRicezione"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DatiRicezione datiRicezione, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, datiRicezione, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DatiRicezione" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="datiRicezione"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DatiRicezione datiRicezione, JsonSerializerOptions jsonSerializerOptions)
        {
            if (datiRicezione.RiferimentoNumeroLineaOption.IsSet)
                if (datiRicezione.RiferimentoNumeroLineaOption.Value != null)
                {
                    writer.WritePropertyName("riferimento_numero_linea");
                    JsonSerializer.Serialize(writer, datiRicezione.RiferimentoNumeroLinea, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("riferimento_numero_linea");
            if (datiRicezione.IdDocumentoOption.IsSet)
                if (datiRicezione.IdDocumentoOption.Value != null)
                    writer.WriteString("id_documento", datiRicezione.IdDocumento);
                else
                    writer.WriteNull("id_documento");

            if (datiRicezione.DataOption.IsSet)
                if (datiRicezione.DataOption.Value != null)
                    writer.WriteString("data", datiRicezione.DataOption.Value.Value.ToString(DataFormat));
                else
                    writer.WriteNull("data");

            if (datiRicezione.NumItemOption.IsSet)
                if (datiRicezione.NumItemOption.Value != null)
                    writer.WriteString("num_item", datiRicezione.NumItem);
                else
                    writer.WriteNull("num_item");

            if (datiRicezione.CodiceCommessaConvenzioneOption.IsSet)
                if (datiRicezione.CodiceCommessaConvenzioneOption.Value != null)
                    writer.WriteString("codice_commessa_convenzione", datiRicezione.CodiceCommessaConvenzione);
                else
                    writer.WriteNull("codice_commessa_convenzione");

            if (datiRicezione.CodiceCupOption.IsSet)
                if (datiRicezione.CodiceCupOption.Value != null)
                    writer.WriteString("codice_cup", datiRicezione.CodiceCup);
                else
                    writer.WriteNull("codice_cup");

            if (datiRicezione.CodiceCigOption.IsSet)
                if (datiRicezione.CodiceCigOption.Value != null)
                    writer.WriteString("codice_cig", datiRicezione.CodiceCig);
                else
