...
namespace Invoicetronic.Sdk.Model
{
    ...
    public partial class DatiRiepilogo : IValidatableObject
    {
        ...
        public DatiRiepilogo(double aliquotaIva = default, string natura = default, double? speseAccessorie = default, double? arrotondamento = default, double imponibileImporto = default, double imposta = default, string esigibilitaIva = default, string riferimentoNormativo = default)
        {
