...
namespace Invoicetronic.Sdk.Model
{
    ...
    public partial class DatiTrasporto : IValidatableObject
    {
        ...
        public DatiTrasporto(DatiAnagraficiVettore datiAnagraficiVettore = default, string mezzoTrasporto = default, string causaleTrasporto = default, int? numeroColli = default, string descrizione = default, string unitaMisuraPeso = default, double? pesoLordo = default, double? pesoNetto = default, DateTime? dataOraRitiro = default, DateTime? dataInizioTrasporto = default, string tipoResa = default, IndirizzoResa indirizzoResa = default, DateTime? dataOraConsegna = default)
        {
