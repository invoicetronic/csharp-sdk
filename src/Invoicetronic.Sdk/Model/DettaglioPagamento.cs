...
namespace Invoicetronic.Sdk.Model
{
    ...
    public partial class DettaglioPagamento : IValidatableObject
    {
        ...
        public DettaglioPagamento(string beneficiario = default, string modalitaPagamento = default, DateTime? dataRiferimentoTerminiPagamento = default, int? giorniTerminiPagamento = default, DateTime? dataScadenzaPagamento = default, double importoPagamento = default, string codUfficioPostale = default, string cognomeQuietanzante = default, string nomeQuietanzante = default, string cfQuietanzante = default, string titoloQuietanzante = default, string istitutoFinanziario = default, string iban = default, string abi = default, string cab = default, string bic = default, double? scontoPagamentoAnticipato = default, DateTime? dataLimitePagamentoAnticipato = default, double? penalitaPagamentiRitardati = default, DateTime? dataDecorrenzaPenale = default, string codicePagamento = default)
        {
