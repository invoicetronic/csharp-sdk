...
namespace Invoicetronic.Sdk.Model
{
    ...
    public partial class Event : IValidatableObject
    {
        ...
        public Event(int id = default, int userId = default, int apiKeyId = default, int? companyId = default, string method = default, string endpoint = default, int apiVersion = default, int statusCode = default, DateTime dateTime = default, string error = default, int? resourceId = default, string userAgent = default, string query = default, string responseBody = default)
        {
        ...
        */
        ...
        /// </summary>
        /// <value>User-Agent header from the HTTP request.</value>
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.UserAgent != null && this.UserAgent.Length > 512)
            {
                yield return new ValidationResult("Invalid value for UserAgent, length must be less than 512.", new [] { "UserAgent" });
            }
