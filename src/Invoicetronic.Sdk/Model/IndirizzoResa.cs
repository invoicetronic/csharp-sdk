...
namespace Invoicetronic.Sdk.Model
{
    ...
    public partial class IndirizzoResa : IValidatableObject
    {
        ...
        public IndirizzoResa(string indirizzo = default, string numeroCivico = default, string cap = default, string comune = default, string provincia = default, string nazione = @"IT")
        {
