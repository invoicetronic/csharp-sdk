...
namespace Invoicetronic.Sdk.Model
{
    ...
    /// IndirizzoResa
    /// </summary>
    public partial class IndirizzoResa : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IndirizzoResa" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public IndirizzoResa(Option<string> indirizzo = default, Option<string> numeroCivico = default, Option<string> cap = default, Option<string> comune = default, Option<string> provincia = default, Option<string> nazione = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="IndirizzoResa" />
    /// </summary>
    public class IndirizzoResaJsonConverter : JsonConverter<IndirizzoResa>
    {
        /// <summary>
        /// Deserializes json to <see cref="IndirizzoResa" />
        /// </summary>
        ...
        public override IndirizzoResa Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new IndirizzoResa(indirizzo, numeroCivico, cap, comune, provincia, nazione);
        }

        /// <summary>
        /// Serializes a <see cref="IndirizzoResa" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="indirizzoResa"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, IndirizzoResa indirizzoResa, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, indirizzoResa, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="IndirizzoResa" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="indirizzoResa"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, IndirizzoResa indirizzoResa, JsonSerializerOptions jsonSerializerOptions)
        {
            if (indirizzoResa.IndirizzoOption.IsSet)
                if (indirizzoResa.IndirizzoOption.Value != null)
                    writer.WriteString("indirizzo", indirizzoResa.Indirizzo);
                else
                    writer.WriteNull("indirizzo");

            if (indirizzoResa.NumeroCivicoOption.IsSet)
                if (indirizzoResa.NumeroCivicoOption.Value != null)
                    writer.WriteString("numero_civico", indirizzoResa.NumeroCivico);
                else
                    writer.WriteNull("numero_civico");

            if (indirizzoResa.CapOption.IsSet)
                if (indirizzoResa.CapOption.Value != null)
                    writer.WriteString("cap", indirizzoResa.Cap);
                else
                    writer.WriteNull("cap");

            if (indirizzoResa.ComuneOption.IsSet)
                if (indirizzoResa.ComuneOption.Value != null)
                    writer.WriteString("comune", indirizzoResa.Comune);
                else
                    writer.WriteNull("comune");

            if (indirizzoResa.ProvinciaOption.IsSet)
                if (indirizzoResa.ProvinciaOption.Value != null)
                    writer.WriteString("provincia", indirizzoResa.Provincia);
                else
                    writer.WriteNull("provincia");

            if (indirizzoResa.NazioneOption.IsSet)
                if (indirizzoResa.NazioneOption.Value != null)
                    writer.WriteString("nazione", indirizzoResa.Nazione);
                else
