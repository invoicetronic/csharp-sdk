...
namespace Invoicetronic.Sdk.Model
{
    ...
    public partial class SedeCessionarioCommittente : IValidatableObject
    {
        ...
        public SedeCessionarioCommittente(string indirizzo = default, string numeroCivico = default, string cap = default, string comune = default, string provincia = default, string nazione = @"IT")
        {
