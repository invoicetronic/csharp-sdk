...
namespace Invoicetronic.Sdk.Model
{
    ...
    public partial class StabileOrganizzazione : IValidatableObject
    {
        ...
        [JsonConstructor]
        public StabileOrganizzazione(Option<string> indirizzo = default, Option<string> numeroCivico = default, Option<string> cap = default, Option<string> comune = default, Option<string> provincia = default, Option<string> nazione = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="StabileOrganizzazione" />
    /// </summary>
    public class StabileOrganizzazioneJsonConverter : JsonConverter<StabileOrganizzazione>
    {
        /// <summary>
        /// Deserializes json to <see cref="StabileOrganizzazione" />
        /// </summary>
        ...
        public override StabileOrganizzazione Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new StabileOrganizzazione(indirizzo, numeroCivico, cap, comune, provincia, nazione);
        }

        /// <summary>
        /// Serializes a <see cref="StabileOrganizzazione" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="stabileOrganizzazione"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, StabileOrganizzazione stabileOrganizzazione, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, stabileOrganizzazione, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="StabileOrganizzazione" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="stabileOrganizzazione"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, StabileOrganizzazione stabileOrganizzazione, JsonSerializerOptions jsonSerializerOptions)
        {
            if (stabileOrganizzazione.IndirizzoOption.IsSet)
                if (stabileOrganizzazione.IndirizzoOption.Value != null)
                    writer.WriteString("indirizzo", stabileOrganizzazione.Indirizzo);
                else
                    writer.WriteNull("indirizzo");

            if (stabileOrganizzazione.NumeroCivicoOption.IsSet)
                if (stabileOrganizzazione.NumeroCivicoOption.Value != null)
                    writer.WriteString("numero_civico", stabileOrganizzazione.NumeroCivico);
                else
                    writer.WriteNull("numero_civico");

            if (stabileOrganizzazione.CapOption.IsSet)
                if (stabileOrganizzazione.CapOption.Value != null)
                    writer.WriteString("cap", stabileOrganizzazione.Cap);
                else
                    writer.WriteNull("cap");

            if (stabileOrganizzazione.ComuneOption.IsSet)
                if (stabileOrganizzazione.ComuneOption.Value != null)
                    writer.WriteString("comune", stabileOrganizzazione.Comune);
                else
                    writer.WriteNull("comune");

            if (stabileOrganizzazione.ProvinciaOption.IsSet)
                if (stabileOrganizzazione.ProvinciaOption.Value != null)
                    writer.WriteString("provincia", stabileOrganizzazione.Provincia);
                else
                    writer.WriteNull("provincia");

            if (stabileOrganizzazione.NazioneOption.IsSet)
                if (stabileOrganizzazione.NazioneOption.Value != null)
                    writer.WriteString("nazione", stabileOrganizzazione.Nazione);
                else
