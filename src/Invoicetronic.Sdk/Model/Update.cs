...
namespace Invoicetronic.Sdk.Model
{
    ...
    public partial class Update : IValidatableObject
    {
        ...
        public Update(int id = default, int userId = default, int companyId = default, int sendId = default, DateTime lastUpdate = default, StateEnum? state = default, string description = default, string messageId = default, List<Error> errors = default, bool isRead = default, SendReduced send = default)
        {
            this.Id = id;
            this.UserId = userId;
