...
namespace Invoicetronic.Sdk.Model
{
    ...
    public partial class WebHook : IValidatableObject
    {
        ...
        /// <param name="companyId">Optional company id. If set, the webhook is restricted to events for that company; if omitted, it fires for all companies on the account..</param>
        ...
        public WebHook(int id = default, int? companyId = default, string url = default, bool enabled = default, string secret = default, string description = default, List<string> events = default)
        {
        ...
        */
        ...
        /// </summary>
        /// <value>Optional company id. If set, the webhook is restricted to events for that company; if omitted, it fires for all companies on the account.</value>
        /*
        <example>1</example>
        */
        ...
        /*
        <example>https://example.com/webhooks/invoicetronic</example>
        */
        ...
        /*
        <example>wh_sec_1a2b3c4d5e6f7g8h9i0j</example>
        */
        ...
        */
        ...
        /*
        <example>[&quot;send.add&quot;,&quot;receive.add&quot;]</example>
        */
        ...
        /// </summary>
        /// <value>Timestamp of the last failure notification email sent for this webhook. Set by the notifier service; reset to null on successful delivery.</value>
        [DataMember(Name = "failure_notified_at", EmitDefaultValue = true)]
        public DateTime? FailureNotifiedAt { get; private set; }

        /// <summary>
        /// Returns false as FailureNotifiedAt should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeFailureNotifiedAt()
        {
            return false;
        }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FailureNotifiedAt: ").Append(FailureNotifiedAt).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
