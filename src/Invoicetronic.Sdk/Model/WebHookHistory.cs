...
namespace Invoicetronic.Sdk.Model
{
    ...
    public partial class WebHookHistory : IValidatableObject
    {
        ...
        public WebHookHistory(int id = default, DateTime created = default, int varVersion = default, int webHookId = default, int userId = default, string varEvent = default, int statusCode = default, DateTime dateTime = default)
        {
            this.Id = id;
