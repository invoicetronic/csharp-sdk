...
namespace Invoicetronic.eInvoice.Sdk.Api
{
    ...
    public interface ISendApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Invoicetronic.eInvoice.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    {
        private Invoicetronic.eInvoice.Sdk.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        {
            this.Configuration = Invoicetronic.eInvoice.Sdk.Client.Configuration.MergeConfigurations(
                Invoicetronic.eInvoice.Sdk.Client.GlobalConfiguration.Instance,
                new Invoicetronic.eInvoice.Sdk.Client.Configuration { BasePath = basePath }
            );
            this.Client = new Invoicetronic.eInvoice.Sdk.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new Invoicetronic.eInvoice.Sdk.Client.ApiClient(this.Configuration.BasePath);
            this.ExceptionFactory = Invoicetronic.eInvoice.Sdk.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// <returns></returns>
        public SendApi(Invoicetronic.eInvoice.Sdk.Client.Configuration configuration)
        {
            ...
            this.Client = new Invoicetronic.eInvoice.Sdk.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new Invoicetronic.eInvoice.Sdk.Client.ApiClient(this.Configuration.BasePath);
            ExceptionFactory = Invoicetronic.eInvoice.Sdk.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        public SendApi(Invoicetronic.eInvoice.Sdk.Client.ISynchronousClient client, Invoicetronic.eInvoice.Sdk.Client.IAsynchronousClient asyncClient, Invoicetronic.eInvoice.Sdk.Client.IReadableConfiguration configuration)
        {
        ...
        /// </summary>
        public Invoicetronic.eInvoice.Sdk.Client.IAsynchronousClient AsynchronousClient { get; set; }

        /// <summary>
        /// The client for accessing this underlying API synchronously.
        /// </summary>
        public Invoicetronic.eInvoice.Sdk.Client.ISynchronousClient Client { get; set; }
        ...
        public Invoicetronic.eInvoice.Sdk.Client.IReadableConfiguration Configuration { get; set; }

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public Invoicetronic.eInvoice.Sdk.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        {
            Invoicetronic.eInvoice.Sdk.Client.ApiResponse<Send> localVarResponse = InvoiceV1SendFilesPostWithHttpInfo(files, validate);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Send</returns>
        public Invoicetronic.eInvoice.Sdk.Client.ApiResponse<Send> InvoiceV1SendFilesPostWithHttpInfo(List<System.IO.Stream> files, bool? validate = default(bool?), int operationIndex = 0)
        {
            // verify the required parameter 'files' is set
            if (files == null)
            {
                throw new Invoicetronic.eInvoice.Sdk.Client.ApiException(400, "Missing required parameter 'files' when calling SendApi->InvoiceV1SendFilesPost");
            }

            Invoicetronic.eInvoice.Sdk.Client.RequestOptions localVarRequestOptions = new Invoicetronic.eInvoice.Sdk.Client.RequestOptions();
            ...
            var localVarContentType = Invoicetronic.eInvoice.Sdk.Client.ClientUtils.SelectHeaderContentType(_contentTypes);
            if (localVarContentType != null)
            {
                localVarRequestOptions.HeaderParameters.Add("Content-Type", localVarContentType);
            }

            var localVarAccept = Invoicetronic.eInvoice.Sdk.Client.ClientUtils.SelectHeaderAccept(_accepts);
            ...
            if (validate != null)
            {
                localVarRequestOptions.QueryParameters.Add(Invoicetronic.eInvoice.Sdk.Client.ClientUtils.ParameterToMultiMap("", "validate", validate));
            }
            ...
            {
                localVarRequestOptions.HeaderParameters.Add("Authorization", "Basic " + Invoicetronic.eInvoice.Sdk.Client.ClientUtils.Base64Encode(this.Configuration.Username + ":" + this.Configuration.Password));
            }
        ...
        {
            Invoicetronic.eInvoice.Sdk.Client.ApiResponse<Send> localVarResponse = await InvoiceV1SendFilesPostWithHttpInfoAsync(files, validate, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Invoicetronic.eInvoice.Sdk.Client.ApiResponse<List<Send>> localVarResponse = InvoiceV1SendGetWithHttpInfo(companyId, identifier, committente, prestatore, fileName, lastUpdateFrom, lastUpdateTo, dateSentFrom, dateSentTo, documentDateFrom, documentDateTo, documentNumber, page, pageSize);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;Send&gt;</returns>
        public Invoicetronic.eInvoice.Sdk.Client.ApiResponse<List<Send>> InvoiceV1SendGetWithHttpInfo(int? companyId = default(int?), string identifier = default(string), string committente = default(string), string prestatore = default(string), string fileName = default(string), DateTime? lastUpdateFrom = default(DateTime?), DateTime? lastUpdateTo = default(DateTime?), DateTime? dateSentFrom = default(DateTime?), DateTime? dateSentTo = default(DateTime?), DateTime? documentDateFrom = default(DateTime?), DateTime? documentDateTo = default(DateTime?), string documentNumber = default(string), int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0)
        {
            Invoicetronic.eInvoice.Sdk.Client.RequestOptions localVarRequestOptions = new Invoicetronic.eInvoice.Sdk.Client.RequestOptions();
            ...
            if (companyId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Invoicetronic.eInvoice.Sdk.Client.ClientUtils.ParameterToMultiMap("", "company_id", companyId));
            }
            if (identifier != null)
            {
                localVarRequestOptions.QueryParameters.Add(Invoicetronic.eInvoice.Sdk.Client.ClientUtils.ParameterToMultiMap("", "identifier", identifier));
            }
            if (committente != null)
            {
                localVarRequestOptions.QueryParameters.Add(Invoicetronic.eInvoice.Sdk.Client.ClientUtils.ParameterToMultiMap("", "committente", committente));
            }
            if (prestatore != null)
            {
                localVarRequestOptions.QueryParameters.Add(Invoicetronic.eInvoice.Sdk.Client.ClientUtils.ParameterToMultiMap("", "prestatore", prestatore));
            }
            if (fileName != null)
            {
                localVarRequestOptions.QueryParameters.Add(Invoicetronic.eInvoice.Sdk.Client.ClientUtils.ParameterToMultiMap("", "file_name", fileName));
            }
            if (lastUpdateFrom != null)
            {
                localVarRequestOptions.QueryParameters.Add(Invoicetronic.eInvoice.Sdk.Client.ClientUtils.ParameterToMultiMap("", "last_update_from", lastUpdateFrom));
            }
            if (lastUpdateTo != null)
            {
                localVarRequestOptions.QueryParameters.Add(Invoicetronic.eInvoice.Sdk.Client.ClientUtils.ParameterToMultiMap("", "last_update_to", lastUpdateTo));
            }
            if (dateSentFrom != null)
            {
                localVarRequestOptions.QueryParameters.Add(Invoicetronic.eInvoice.Sdk.Client.ClientUtils.ParameterToMultiMap("", "date_sent_from", dateSentFrom));
            }
            if (dateSentTo != null)
            {
                localVarRequestOptions.QueryParameters.Add(Invoicetronic.eInvoice.Sdk.Client.ClientUtils.ParameterToMultiMap("", "date_sent_to", dateSentTo));
            }
            if (documentDateFrom != null)
            {
                localVarRequestOptions.QueryParameters.Add(Invoicetronic.eInvoice.Sdk.Client.ClientUtils.ParameterToMultiMap("", "document_date_from", documentDateFrom));
            }
            if (documentDateTo != null)
            {
                localVarRequestOptions.QueryParameters.Add(Invoicetronic.eInvoice.Sdk.Client.ClientUtils.ParameterToMultiMap("", "document_date_to", documentDateTo));
            }
            if (documentNumber != null)
            {
                localVarRequestOptions.QueryParameters.Add(Invoicetronic.eInvoice.Sdk.Client.ClientUtils.ParameterToMultiMap("", "document_number", documentNumber));
            }
            if (page != null)
            {
                localVarRequestOptions.QueryParameters.Add(Invoicetronic.eInvoice.Sdk.Client.ClientUtils.ParameterToMultiMap("", "page", page));
            }
            if (pageSize != null)
            {
                localVarRequestOptions.QueryParameters.Add(Invoicetronic.eInvoice.Sdk.Client.ClientUtils.ParameterToMultiMap("", "page_size", pageSize));
            }
        ...
        {
            Invoicetronic.eInvoice.Sdk.Client.ApiResponse<List<Send>> localVarResponse = await InvoiceV1SendGetWithHttpInfoAsync(companyId, identifier, committente, prestatore, fileName, lastUpdateFrom, lastUpdateTo, dateSentFrom, dateSentTo, documentDateFrom, documentDateTo, documentNumber, page, pageSize, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Send&gt;)</returns>
        public async System.Threading.Tasks.Task<Invoicetronic.eInvoice.Sdk.Client.ApiResponse<List<Send>>> InvoiceV1SendGetWithHttpInfoAsync(int? companyId = default(int?), string identifier = default(string), string committente = default(string), string prestatore = default(string), string fileName = default(string), DateTime? lastUpdateFrom = default(DateTime?), DateTime? lastUpdateTo = default(DateTime?), DateTime? dateSentFrom = default(DateTime?), DateTime? dateSentTo = default(DateTime?), DateTime? documentDateFrom = default(DateTime?), DateTime? documentDateTo = default(DateTime?), string documentNumber = default(string), int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        {
            Invoicetronic.eInvoice.Sdk.Client.ApiResponse<Send> localVarResponse = InvoiceV1SendIdGetWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Send</returns>
        public Invoicetronic.eInvoice.Sdk.Client.ApiResponse<Send> InvoiceV1SendIdGetWithHttpInfo(int id, int operationIndex = 0)
        {
            Invoicetronic.eInvoice.Sdk.Client.RequestOptions localVarRequestOptions = new Invoicetronic.eInvoice.Sdk.Client.RequestOptions();
            ...
            localVarRequestOptions.PathParameters.Add("id", Invoicetronic.eInvoice.Sdk.Client.ClientUtils.ParameterToString(id)); // path parameter
        ...
        {
            Invoicetronic.eInvoice.Sdk.Client.ApiResponse<Send> localVarResponse = await InvoiceV1SendIdGetWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Send)</returns>
        public async System.Threading.Tasks.Task<Invoicetronic.eInvoice.Sdk.Client.ApiResponse<Send>> InvoiceV1SendIdGetWithHttpInfoAsync(int id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        {
            Invoicetronic.eInvoice.Sdk.Client.ApiResponse<Send> localVarResponse = InvoiceV1SendJsonPostWithHttpInfo(fatturaOrdinaria, validate);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Send</returns>
        public Invoicetronic.eInvoice.Sdk.Client.ApiResponse<Send> InvoiceV1SendJsonPostWithHttpInfo(FatturaOrdinaria fatturaOrdinaria, bool? validate = default(bool?), int operationIndex = 0)
        {
            // verify the required parameter 'fatturaOrdinaria' is set
            if (fatturaOrdinaria == null)
            {
                throw new Invoicetronic.eInvoice.Sdk.Client.ApiException(400, "Missing required parameter 'fatturaOrdinaria' when calling SendApi->InvoiceV1SendJsonPost");
            }
        ...
        {
            Invoicetronic.eInvoice.Sdk.Client.ApiResponse<Send> localVarResponse = await InvoiceV1SendJsonPostWithHttpInfoAsync(fatturaOrdinaria, validate, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Send)</returns>
        public async System.Threading.Tasks.Task<Invoicetronic.eInvoice.Sdk.Client.ApiResponse<Send>> InvoiceV1SendJsonPostWithHttpInfoAsync(FatturaOrdinaria fatturaOrdinaria, bool? validate = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'fatturaOrdinaria' is set
            if (fatturaOrdinaria == null)
            {
        ...
        {
            Invoicetronic.eInvoice.Sdk.Client.ApiResponse<Send> localVarResponse = InvoiceV1SendPostWithHttpInfo(send, validate);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Send</returns>
        public Invoicetronic.eInvoice.Sdk.Client.ApiResponse<Send> InvoiceV1SendPostWithHttpInfo(Send send, bool? validate = default(bool?), int operationIndex = 0)
        {
            // verify the required parameter 'send' is set
            if (send == null)
            {
                throw new Invoicetronic.eInvoice.Sdk.Client.ApiException(400, "Missing required parameter 'send' when calling SendApi->InvoiceV1SendPost");
            }
        ...
        {
            Invoicetronic.eInvoice.Sdk.Client.ApiResponse<Send> localVarResponse = await InvoiceV1SendPostWithHttpInfoAsync(send, validate, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Send)</returns>
        public async System.Threading.Tasks.Task<Invoicetronic.eInvoice.Sdk.Client.ApiResponse<Send>> InvoiceV1SendPostWithHttpInfoAsync(Send send, bool? validate = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'send' is set
            if (send == null)
            {
        ...
        {
            Invoicetronic.eInvoice.Sdk.Client.ApiResponse<Send> localVarResponse = InvoiceV1SendXmlPostWithHttpInfo(fatturaOrdinaria, validate);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Send</returns>
        public Invoicetronic.eInvoice.Sdk.Client.ApiResponse<Send> InvoiceV1SendXmlPostWithHttpInfo(FatturaOrdinaria fatturaOrdinaria, bool? validate = default(bool?), int operationIndex = 0)
        {
            // verify the required parameter 'fatturaOrdinaria' is set
            if (fatturaOrdinaria == null)
            {
                throw new Invoicetronic.eInvoice.Sdk.Client.ApiException(400, "Missing required parameter 'fatturaOrdinaria' when calling SendApi->InvoiceV1SendXmlPost");
            }
        ...
        {
            Invoicetronic.eInvoice.Sdk.Client.ApiResponse<Send> localVarResponse = await InvoiceV1SendXmlPostWithHttpInfoAsync(fatturaOrdinaria, validate, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
