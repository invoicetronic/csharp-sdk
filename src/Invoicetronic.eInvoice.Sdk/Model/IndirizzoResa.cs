...
namespace Invoicetronic.eInvoice.Sdk.Model
{
    ...
    /// IndirizzoResa
    /// </summary>
    [DataContract(Name = "IndirizzoResa")]
    public partial class IndirizzoResa : IValidatableObject
    {
        ...
        public IndirizzoResa(string indirizzo = default(string), string numeroCivico = default(string), string cap = default(string), string comune = default(string), string provincia = default(string), string nazione = @"IT")
        {
